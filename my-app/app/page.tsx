...
import Tilt from 'react-parallax-tilt'; // 引入 3D 套件
...
export default function CompanyHome() {
  return (
    // min-h-screen bg-slate-950 確保底色是黑的
    <div className="flex flex-col items-center w-full">
      ...
      {/* 2. 內容層 (z-10) */}
        ...
        <section className="w-full max-w-5xl px-6 py-32 text-center">
          {/* <div className="inline-block mb-6 px-4 py-1.5 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-300 text-sm font-semibold tracking-wide backdrop-blur-sm">
            🚀 Automate Boring Tasks for &lt; $10/Day
          </div> */}
        ...
        <section id="contact" className="w-full px-6 py-24 mt-12">
          {/* 因為背景已經是全域的了，這裡不需要額外的 background div，直接放內容即可 */}
